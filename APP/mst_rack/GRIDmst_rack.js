...
Ext.define("NJC.mst_rack.GRIDmst_rack", {
  extend: "Ext.form.Panel",
  alias: "widget.GRIDmst_rack",
  reference: "GRIDmst_rack",
  frame: false,
  border: false,
  autoScroll: true,
  ...
  items: [
    {
      ...
      columns: {
        ...
        items: [
          ...
          { header: "LOKASI RACK", dataIndex: "rack_location",  width: 200, },
          { header: "RACK NO", dataIndex: "rack_no",  width: 200, },
          ...
          { header: "UPDATE", dataIndex: "SYSUPDATEUSER", width: 150 },
          {
            header: "DATE",
  ...
  dockedItems: [
    {
      ...
      items: [
...

        {
          ...
          tooltip: "New Input",
          pid: "btinput_mst_rack",
          handler: "btinput_mst_rack_click",
        },
        "->",
        {
          xtype: "button",
      ...
      Ext.MessageBox.show(
        {
          ...
          msg: [
            //
            "<ul>",
            "<li>Konfirmasi proses download Data Rack Location</li>",
            "</ul>",
          ].join(""),
