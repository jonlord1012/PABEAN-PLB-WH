Ext.define("NJC.rpt_inc_material.GRIDrpt_inc_material", {
  extend: "Ext.form.Panel",
  alias: "widget.GRIDrpt_inc_material",
  reference: "GRIDrpt_inc_material",
  frame: false,
  border: false,
  autoScroll: true,
  ...
  items: [
    {
      ...
      store: {
        ...
        proxy: {
          ...
          url: vconfig.service_api + "rpt_inc_material/rpt_inc_materials",
          extraParams: {
            method: "read_data",
          },
          reader: {
