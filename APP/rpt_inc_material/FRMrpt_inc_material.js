...
Ext.define("NJC.rpt_inc_material.FRMrpt_inc_material", {
  extend: "Ext.window.Window",
  alias: "widget.FRMrpt_inc_material",
  reference: "FRMrpt_inc_material",
  title: "Report Inc Material",
  modal: true,
  closeAction: "destroy",
  centered: true,
      ...
      items: [
        {
          ...
          store: {
            ...
            proxy: {
              ...
              url:
                vconfig.service_api +
                "rpt_inc_material/rpt_inc_materials",
              reader: {
                type: "json",
                rootProperty: "Rows",
            ...
            { xtype: "tbspacer", width: 5 },
            {
              ...
              handler: function (cmp) {
                try {
                  ...
                  var GRID = FRM.query(
                    "grid[pid=GRIDFRMrpt_inc_material]"
                  )[0];
                  GRID.getStore()
                    .getDataSource()
                    .each(function (rec) {
  ...
  btsearch_aju_click: function (cmp) {
    try {
      ...
      var popup = Ext.create(
        "NJC.rpt_inc_material.FRMrpt_inc_material_list_aju",
        {}
      );
      var GRIDrpt_inc_material = FRMmain.query(
        "grid[pid=GRIDFRMrpt_inc_material]"
      )[0];
      ...
      GRIDwh_receivingpart_list_aju.on(
        ...
        function (xgrid, rec) {
          try {
            ...
            GRIDrpt_inc_material.getStore().load();
          } catch (ex) {
            COMP.TipToast.toast("Error", ex.message, {
              cls: "danger",
              delay: 2000,
      ...
      GRIDrpt_inc_material.getStore().on(
        "beforeload",
  ...
  handler_btsave_data: function (btn) {
    try {
      ...
      var GRIDrpt_inc_material = MODULEmain.query(
        "grid[pid=GRIDrpt_inc_material]"
      )[0];
      var GRIDFRMrpt_inc_material = PAGEthis.query(
        "grid[pid=GRIDFRMrpt_inc_material]"
      )[0];
      ...
      var nvdetail = [];
      GRIDFRMrpt_inc_material.getStore().each(function (record) {
        ...
        function (button) {
          if (button === "yes") {
            ...
            var hasil = COMP.run.getservice(
              vconfig.service_api +
              "rpt_inc_material/rpt_inc_material",
              params,
              "POST",
