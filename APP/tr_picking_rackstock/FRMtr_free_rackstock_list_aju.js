...
Ext.define("NJC.tr_free_rackstock.FRMtr_free_rackstock_list_aju", {
  extend: "Ext.window.Window",
  alias: "widget.FRMtr_free_rackstock_list_aju",
  reference: "FRMtr_free_rackstock_list_aju",
  title: "List Aju",
  modal: true,
  closeAction: "destroy",
  centered: true,
  ...
  items: [
    {
      ...
      store: {
        ...
        proxy: {
          ...
          url:
            vconfig.service_api +
            "tr_free_rackstock/tr_free_rackstocks",
          extraParams: {
  ...
  handler_btsave_data: function (btn) {
    try {
      ...
      var GRIDtr_free_rackstock = MODULEmain.query(
        "grid[pid=GRIDtr_free_rackstock]"
      )[0];
        ...
        function (button) {
          if (button === "yes") {
            ...
            var hasil = COMP.run.getservice(
              vconfig.service_api +
                "tr_free_rackstock/tr_free_rackstock",
              params,
              "POST",
            ...
            hasil.then(function (content) {
              ...
              if (val.success === "true") {
                ...
                GRIDtr_free_rackstock.getStore().load();
                PAGEthis.close();
              } else {
