Ext.define("NJC.tr_picking_rackstock.GRIDtr_picking_rackstock", {
  extend: "Ext.form.Panel",
  alias: "widget.GRIDtr_picking_rackstock",
  reference: "GRIDtr_picking_rackstock",
  frame: false,
  border: false,
  autoScroll: true,
  ...
  items: [
    {
      ...
      store: {
        ...
        proxy: {
          ...
          url: vconfig.service_api + "tr_picking_rackstock/tr_picking_rackstocks",
          extraParams: {
            method: "read_data",
          },
          reader: {
