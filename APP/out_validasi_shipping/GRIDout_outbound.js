Ext.define("NJC.out_outbound.GRIDout_outbound", {
  extend: "Ext.form.Panel",
  alias: "widget.GRIDout_outbound",
  reference: "GRIDout_outbound",
  frame: false,
  border: false,
  autoScroll: true,
  ...
  items: [
    {
      ...
      store: {
        ...
        proxy: {
          ...
          url: vconfig.service_api + "out_outbound/out_outbounds",
          extraParams: {
            method: "read_data",
          },
          reader: {
