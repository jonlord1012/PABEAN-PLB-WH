...
Ext.define("NJC.mst_category_item.FRMmst_category_item", {
  extend: "Ext.window.Window",
  alias: "widget.FRMmst_category_item",
  reference: "FRMmst_category_item",
  title: "Category Part Item/Material",
  modal: true,
  closeAction: "destroy",
  centered: true,
  ...
  handler_btsave_data: function (btn) {
    try {
      ...
      var GRIDmst_category_item = MODULEmain.query("grid[pid=GRIDmst_category_item]")[0];
          ...
          if (button === "yes") {
            ...
            hasil.then(function (content) {
              ...
              if (val.success === "true") {
                ...
                GRIDmst_category_item.getStore().load();
                PAGEthis.close();
              } else {
