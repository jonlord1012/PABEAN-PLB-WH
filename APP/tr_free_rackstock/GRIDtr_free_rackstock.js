Ext.define("NJC.tr_free_rackstock.GRIDtr_free_rackstock", {
  extend: "Ext.form.Panel",
  alias: "widget.GRIDtr_free_rackstock",
  reference: "GRIDtr_free_rackstock",
  frame: false,
  border: false,
  autoScroll: true,
  ...
  items: [
    {
      ...
      store: {
        ...
        proxy: {
          ...
          url: vconfig.service_api + "tr_free_rackstock/tr_free_rackstocks",
          extraParams: {
            method: "read_data",
          },
          reader: {
