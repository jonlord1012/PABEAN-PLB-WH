Ext.define("NJC.out_reqmat_pemi.GRIDout_reqmat_pemi", {
  extend: "Ext.form.Panel",
  alias: "widget.GRIDout_reqmat_pemi",
  reference: "GRIDout_reqmat_pemi",
  frame: false,
  border: false,
  autoScroll: true,
  ...
  items: [
    {
      ...
      store: {
        ...
        proxy: {
          ...
          url: vconfig.service_api + "out_reqmat_pemi/out_reqmat_pemis",
          extraParams: {
            method: "read_data",
          },
          reader: {
