Ext.define("NJC.wh_receiving_label.GRIDwh_receiving_label", {
  extend: "Ext.form.Panel",
  alias: "widget.GRIDwh_receiving_label",
  reference: "GRIDwh_receiving_label",
  frame: false,
  border: false,
  autoScroll: true,
  ...
  items: [
    {
      ...
      store: {
        ...
        proxy: {
          ...
          url: vconfig.service_api + "wh_receiving_label/wh_receiving_labels",
          extraParams: {
            method: "read_data",
          },
          reader: {
