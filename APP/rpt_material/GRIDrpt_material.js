Ext.define("NJC.rpt_material.GRIDrpt_material", {
  extend: "Ext.form.Panel",
  alias: "widget.GRIDrpt_material",
  reference: "GRIDrpt_material",
  frame: false,
  border: false,
  autoScroll: true,
  ...
  items: [
    {
      ...
      store: {
        ...
        proxy: {
          ...
          url: vconfig.service_api + "rpt_material/rpt_materials",
          extraParams: {
            method: "read_data",
          },
          reader: {
