...
Ext.define("NJC.wh_returnitem.FRMwh_returnitem_list_aju", {
  extend: "Ext.window.Window",
  alias: "widget.FRMwh_returnitem_list_aju",
  reference: "FRMwh_returnitem_list_aju",
  title: "List Aju",
  modal: true,
  closeAction: "destroy",
  centered: true,
  ...
  handler_btsave_data: function (btn) {
    try {
      ...
      var GRIDwh_returnitem = MODULEmain.query(
        "grid[pid=GRIDwh_returnitem]"
      )[0];
          ...
          if (button === "yes") {
            ...
            hasil.then(function (content) {
              ...
              if (val.success === "true") {
                ...
                GRIDwh_returnitem.getStore().load();
                PAGEthis.close();
              } else {
