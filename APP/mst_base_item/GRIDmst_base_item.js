...
Ext.define("NJC.mst_base_item.GRIDmst_base_item", {
  extend: "Ext.form.Panel",
  alias: "widget.GRIDmst_base_item",
  reference: "GRIDmst_base_item",
  frame: false,
  border: false,
  autoScroll: true,
  ...
  items: [
    {
      ...
      store: {
        ...
        proxy: {
          ...
          url: vconfig.service_api + "mst_base_item/mst_base_items",
          reader: {
            type: "json",
            rootProperty: "Rows",
            ...
            items: [
              {
                ...
                handler: "GRIDmst_base_item_click",
                tooltip: "Detail Dokumen",
              },
            ],
          },
          { header: "KODE BASE", dataIndex: "defcode" },
          { header: "NAMA BASE", dataIndex: "defname" },
        ],
      },
      bbar: {
        xtype: "pagingtoolbar",
  ...
  dockedItems: [
    {
      ...
      items: [
...

        {
          ...
          tooltip: "New Input",
          pid: "btinput_mst_base_item",
          handler: "btinput_mst_base_item_click",
        },
        "->",
        {
          xtype: "button",
      ...
      Ext.MessageBox.show(
        {
          ...
          msg: [
            //
            "<ul>",
            "<li>Konfirmasi proses download Data Base Part Item/Material</li>",
            "</ul>",
          ].join(""),
