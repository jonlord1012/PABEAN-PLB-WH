Ext.define("NJC.tr_adjustment_stock.GRIDtr_adjustment_stock", {
  extend: "Ext.form.Panel",
  alias: "widget.GRIDtr_adjustment_stock",
  reference: "GRIDtr_adjustment_stock",
  frame: false,
  border: false,
  autoScroll: true,
  ...
  items: [
    {
      ...
      store: {
        ...
        proxy: {
          ...
          url: vconfig.service_api + "tr_adjustment_stock/tr_adjustment_stocks",
          extraParams: {
            method: "read_data",
          },
          reader: {
