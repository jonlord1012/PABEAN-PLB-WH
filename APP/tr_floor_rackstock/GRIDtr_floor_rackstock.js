Ext.define("NJC.tr_floor_rackstock.GRIDtr_floor_rackstock", {
  extend: "Ext.form.Panel",
  alias: "widget.GRIDtr_floor_rackstock",
  reference: "GRIDtr_floor_rackstock",
  frame: false,
  border: false,
  autoScroll: true,
  ...
  items: [
    {
      ...
      store: {
        ...
        proxy: {
          ...
          url: vconfig.service_api + "tr_floor_rackstock/tr_floor_rackstocks",
          extraParams: {
            method: "read_data",
          },
          reader: {
