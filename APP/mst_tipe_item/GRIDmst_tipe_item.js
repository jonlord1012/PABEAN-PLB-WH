...
Ext.define("NJC.mst_tipe_item.GRIDmst_tipe_item", {
  extend: "Ext.form.Panel",
  alias: "widget.GRIDmst_tipe_item",
  reference: "GRIDmst_tipe_item",
  frame: false,
  border: false,
  autoScroll: true,
  ...
  items: [
    {
      ...
      store: {
        ...
        proxy: {
          ...
          url: vconfig.service_api + "mst_tipe_item/mst_tipe_items",
          reader: {
            type: "json",
            rootProperty: "Rows",
      ...
      columns: {
        ...
        items: [
          ...
          { header: "defid", dataIndex: "defid", filter: false, sortable: false, hidden: true },
          {
            xtype: "actioncolumn",
            width: 35,
            align: "center",
            ...
            items: [
              {
                ...
                handler: "GRIDmst_tipe_item_click",
                tooltip: "Detail Dokumen",
              },
            ],
          },
          { header: "KODE TIPE", dataIndex: "defcode" },
          { header: "NAMA TIPE", dataIndex: "defname" },
        ],
      },
      bbar: {
        xtype: "pagingtoolbar",
  ...
  dockedItems: [
    {
      ...
      items: [
...

        {
          ...
          tooltip: "New Input",
          pid: "btinput_mst_tipe_item",
          handler: "btinput_mst_tipe_item_click",
        },
        "->",
        {
          xtype: "button",
      ...
      Ext.MessageBox.show(
        {
          ...
          msg: [
            //
            "<ul>",
            "<li>Konfirmasi proses download Data Tipe Part Item/Material</li>",
            "</ul>",
          ].join(""),
