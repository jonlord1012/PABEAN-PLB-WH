...
Ext.define("NJC.mst_group_item.FRMmst_group_item", {
  extend: "Ext.window.Window",
  alias: "widget.FRMmst_group_item",
  reference: "FRMmst_group_item",
  title: "Group Part Item/Material",
  modal: true,
  closeAction: "destroy",
  centered: true,
  ...
  handler_btsave_data: function (btn) {
    try {
      ...
      var GRIDmst_group_item = MODULEmain.query("grid[pid=GRIDmst_group_item]")[0];

      var FRM = PAGEthis.query("form")[0];
      var dtval = FRM.getValues(false, false, false, true);
      if (Ext.isEmpty(dtval.defcode)) {
        COMP.TipToast.msgbox("Error", "Kode Group harus diisi!", { cls: "danger", delay: 3000 });
        return false;
      }
      if (Ext.isEmpty(dtval.defname)) {
        COMP.TipToast.msgbox("Error", "Nama Group harus diisi!", { cls: "danger", delay: 3000 });
        return false;
      }
          ...
          if (button === "yes") {
            ...
            hasil.then(function (content) {
              ...
              if (val.success === "true") {
                ...
                GRIDmst_group_item.getStore().load();
                PAGEthis.close();
              } else {
