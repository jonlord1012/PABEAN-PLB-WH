...
var mainpanel = Ext.ComponentQuery.query("mainpage")[0];Ext.define("NJC.mst_group_item.GRIDmst_group_item", {
  extend: "Ext.form.Panel",
  alias: "widget.GRIDmst_group_item",
  reference: "GRIDmst_group_item",
  frame: false,
  border: false,
  autoScroll: true,
  ...
  items: [
    {
      ...
      store: {
        ...
        proxy: {
          ...
          url: vconfig.service_api + "mst_group_item/mst_group_items",
          reader: {
            type: "json",
            rootProperty: "Rows",
            ...
            items: [
              {
                ...
                handler: "GRIDmst_group_item_click",
                tooltip: "Detail Dokumen",
              },
            ],
          },
          { header: "KODE GROUP", dataIndex: "defcode" },
          { header: "NAMA GROUP", dataIndex: "defname" },
        ],
      },
      bbar: {
        xtype: "pagingtoolbar",
  ...
  dockedItems: [
    {
      ...
      items: [
...

        {
          ...
          tooltip: "New Input",
          pid: "btinput_mst_group_item",
          handler: "btinput_mst_group_item_click",
        },
        "->",
        {
          xtype: "button",
      ...
      Ext.MessageBox.show(
        {
          ...
          msg: [
            //
            "<ul>",
            "<li>Konfirmasi proses download Data Group Part Item/Material</li>",
            "</ul>",
          ].join(""),
          ...
          fn: function (btconfirm) {
            if (btconfirm === "no") {
              ...
              var hasil = COMP.run.getservice(vconfig.service_api + "mst_group_item/mst_group_item", params, "POST", localStorage.getItem("NJC_JWT"));
