...
Ext.define("NJC.mst_unit_item.GRIDmst_unit_item", {
  extend: "Ext.form.Panel",
  alias: "widget.GRIDmst_unit_item",
  reference: "GRIDmst_unit_item",
  frame: false,
  border: false,
  autoScroll: true,
  ...
  items: [
    {
      ...
      store: {
        ...
        proxy: {
          ...
          url: vconfig.service_api + "mst_unit_item/mst_unit_items",
          reader: {
            type: "json",
            rootProperty: "Rows",
            ...
            items: [
              {
                ...
                handler: "GRIDmst_unit_item_click",
                tooltip: "Detail Dokumen",
              },
            ],
          },
          { header: "KODE UNIT", dataIndex: "defcode" },
          { header: "NAMA UNIT", dataIndex: "defname" },
        ],
      },
      bbar: {
        xtype: "pagingtoolbar",
  ...
  dockedItems: [
    {
      ...
      items: [
...

        {
          ...
          tooltip: "New Input",
          pid: "btinput_mst_unit_item",
          handler: "btinput_mst_unit_item_click",
        },
        "->",
        {
          xtype: "button",
      ...
      Ext.MessageBox.show(
        {
          ...
          msg: [
            //
            "<ul>",
            "<li>Konfirmasi proses download Data Unit Part Item/Material</li>",
            "</ul>",
          ].join(""),
