Ext.define("NJC.rpt_out_material.GRIDrpt_out_material", {
  extend: "Ext.form.Panel",
  alias: "widget.GRIDrpt_out_material",
  reference: "GRIDrpt_out_material",
  frame: false,
  border: false,
  autoScroll: true,
  ...
  items: [
    {
      ...
      store: {
        ...
        proxy: {
          ...
          url: vconfig.service_api + "rpt_out_material/rpt_out_materials",
          extraParams: {
            method: "read_data",
          },
          reader: {
