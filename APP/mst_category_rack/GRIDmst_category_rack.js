...
Ext.define("NJC.mst_category_rack.GRIDmst_category_rack", {
  extend: "Ext.form.Panel",
  alias: "widget.GRIDmst_category_rack",
  reference: "GRIDmst_category_rack",
  frame: false,
  border: false,
  autoScroll: true,
            ...
            items: [
              {
                ...
                handler: "GRIDmst_category_rack_click",
  ...
  dockedItems: [
    {
      ...
      items: [
...

        {
          ...
          tooltip: "New Input",
          pid: "btinput_mst_category_rack",
          handler: "btinput_mst_category_rack_click",
        },
        "->",
        {
          xtype: "button",
      ...
      Ext.MessageBox.show(
        {
          ...
          msg: [
            //
            "<ul>",
            "<li>Konfirmasi proses download Data Category Rack</li>",
            "</ul>",
          ].join(""),
