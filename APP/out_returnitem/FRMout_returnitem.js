...
Ext.define("NJC.out_returnitem.FRMout_returnitem", {
  extend: "Ext.window.Window",
  alias: "widget.FRMout_returnitem",
  reference: "FRMout_returnitem",
  title: "Input Return Item",
  modal: true,
  closeAction: "destroy",
  centered: true,
      ...
      items: [
        {
          ...
          store: {
            ...
            proxy: {
              ...
              url:
                vconfig.service_api +
                "out_returnitem/out_returnitems",
              reader: {
                type: "json",
                rootProperty: "Rows",
            ...
            { xtype: "tbspacer", width: 5 },
            {
              ...
              handler: function (cmp) {
                try {
                  ...
                  var GRID = FRM.query(
                    "grid[pid=GRIDFRMout_returnitem]"
                  )[0];
                  GRID.getStore()
                    .getDataSource()
                    .each(function (rec) {
  ...
  btsearch_aju_click: function (cmp) {
    try {
      ...
      var popup = Ext.create(
        "NJC.out_returnitem.FRMout_returnitem_list_aju",
        {}
      );
      var GRIDout_returnitem = FRMmain.query(
        "grid[pid=GRIDFRMout_returnitem]"
      )[0];
      ...
      GRIDwh_receivingpart_list_aju.on(
        ...
        function (xgrid, rec) {
          try {
            ...
            GRIDout_returnitem.getStore().load();
          } catch (ex) {
            COMP.TipToast.toast("Error", ex.message, {
              cls: "danger",
              delay: 2000,
      ...
      GRIDout_returnitem.getStore().on(
        "beforeload",
  ...
  handler_btsave_data: function (btn) {
    try {
      ...
      var GRIDout_returnitem = MODULEmain.query(
        "grid[pid=GRIDout_returnitem]"
      )[0];
      var GRIDFRMout_returnitem = PAGEthis.query(
        "grid[pid=GRIDFRMout_returnitem]"
      )[0];
      ...
      var nvdetail = [];
      GRIDFRMout_returnitem.getStore().each(function (record) {
