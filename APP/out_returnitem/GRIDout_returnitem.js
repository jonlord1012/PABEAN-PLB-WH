Ext.define("NJC.out_returnitem.GRIDout_returnitem", {
  extend: "Ext.form.Panel",
  alias: "widget.GRIDout_returnitem",
  reference: "GRIDout_returnitem",
  frame: false,
  border: false,
  autoScroll: true,
  ...
  items: [
    {
      ...
      store: {
        ...
        proxy: {
          ...
          url: vconfig.service_api + "out_returnitem/out_returnitems",
          extraParams: {
            method: "read_data",
          },
          reader: {
