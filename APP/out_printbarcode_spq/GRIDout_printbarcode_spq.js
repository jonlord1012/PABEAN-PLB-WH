Ext.define("NJC.out_printbarcode_spq.GRIDout_printbarcode_spq", {
  extend: "Ext.form.Panel",
  alias: "widget.GRIDout_printbarcode_spq",
  reference: "GRIDout_printbarcode_spq",
  frame: false,
  border: false,
  autoScroll: true,
  ...
  items: [
    {
      ...
      store: {
        ...
        proxy: {
          ...
          url: vconfig.service_api + "out_printbarcode_spq/out_printbarcode_spqs",
          extraParams: {
            method: "read_data",
          },
          reader: {
