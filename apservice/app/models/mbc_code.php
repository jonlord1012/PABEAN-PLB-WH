...
class Mbc_code extends Model
{
    ...
    {
        $query = DB::table('cpmatrix')
            ->select('defcode as BC Code', 'defname as BC Name')
            ->where('defmodule', '=', 'MBC_CODE');
        ...
        $date = new DateTime();
        $vfilename = "data_bc_code_download_" . $date->format('Y_m_d_H_i_s') . ".xlsx";
