...
class Mrptassetb extends Model
{
    ...
    public static function read_data($param)
    {
        $query = DB::table('assetdata')
            ->select(
                ...
                'derived_table.period as period',
                'assetdata.assetno',
                'assetdata.assetkey',
            ...
            ->join(
                DB::raw("(WITH derived_table AS (
                            SELECT A.assetno, A.assetcondition, B.period
                            FROM stodata A
                            LEFT JOIN speriod B
                            ...
                            AND A.assetcondition LIKE '%IDLE%'
                            GROUP BY A.assetno, A.assetcondition, B.period
