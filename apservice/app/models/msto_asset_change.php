...
class Msto_asset_change extends Model
{
    ...
    public static function save_data($param)
    {
        ...
        if (!empty($vdata['periodeid'])) {
            $updatedGroup = DB::table('assetchange')->where('periodeid', $vdata['periodeid'])->update(array_filter($field));
            ...
            DB::table('assetchange')->update(['status' => false]);
            $createdGroup = DB::table('assetchange')->insert(array_filter($field));
    ...
    public static function delete_data($param)
    {
        ...
        $deleted = DB::table('assetchange')->where('periodeid', $vdata['periodeid'])->delete();
